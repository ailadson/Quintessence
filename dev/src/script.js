/*! Quintessence - v0.0.1 - 2014-10-26 */window.mobilecheck = function() {
var check = false;
...
Ether.Ether.prototype.save = function(){
	...
	// window.localStorage.ETHER = window.localStorage.ETHER || { ethers : [] };
	// window.localStorage.ETHER.ethers.push();
...
Ether.Trophy.prototype.save = function(ether){
	...
	this.width = engine.width*50;
	this.height = engine.height*50;
	this.x = engine.width/2;
	this.y = engine.height/2;
	this.xv = 0;
	this.yv = 0;
	...
	this.numberOfSmallElements = 500;
	this.numberOfMidElements = 100;
	this.numberOfLargeElements = 50;
...
Ether.World.prototype.reInit = function(){
	...
	this.numberOfSmallElements += Math.round(this.numberOfSmallElements * 1.1);
	this.numberOfMidElements += Math.round(this.numberOfMidElements * 1.1);
	this.numberOfLargeElements += Math.round(this.numberOfLargeElements * 1.1);
	this.numberOfBadElements += Math.round(this.numberOfBadElements *1.5);
...
Ether.World.prototype.createElements = function(){
	for (var i = 0; i < this.elements.length; i++) {
		...
		this.initBadGuys(type,collection,this.numberOfBadElements,true);
